  ...
  render () {
    ...
    return (
        <div className="main-app">
          <NavBar location={ location } getCurrentPosition={ this.getCurrentPosition } loading={ this.state.loading } />
          { this.state.welcome && <Welcome getCurrentPosition={ this.getCurrentPosition }
      loading={ this.state.loading }/> }
		  <Search startLoading={ this.startLoading } />
		  { !this.state.welcome && <ForecastMain forecast={ this.state.forecast } /> }
        </div>
     );
  }
}
